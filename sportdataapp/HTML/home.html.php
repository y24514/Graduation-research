...
<div class="home">
    <?php if (!empty($dbErrorMessage)): ?>
        <div class="home-db-error" role="alert">
            <?= htmlspecialchars($dbErrorMessage, ENT_QUOTES, 'UTF-8') ?>
        </div>
    <?php endif; ?>
    <!-- ホーム画面 -->
        ...
        <div class="home-top-row">
            ...
            <div class="user-card card">
                <div class="card-body">
                    ...
                    <a href="<?= htmlspecialchars(sportdata_add_tab_id('pi.php', $__tabId), ENT_QUOTES, 'UTF-8') ?>" class="user-link-btn">
